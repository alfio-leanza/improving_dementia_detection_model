...
def main():
    ...
    writer = SummaryWriter('/home/alfio/improving_dementia_detection_model/explainability-dementia-alfio/5_seed_ovr_CV_1e_7/runs/train_{}'.format(session_timestamp))
    checkpoint_save_dir = f'/home/alfio/improving_dementia_detection_model/explainability-dementia-alfio/5_seed_ovr_CV_1e_7/checkpoints/train_{session_timestamp}/'
    results_save_dir = f'/home/alfio/improving_dementia_detection_model/explainability-dementia-alfio/5_seed_ovr_CV_1e_7/results/train_{session_timestamp}'
