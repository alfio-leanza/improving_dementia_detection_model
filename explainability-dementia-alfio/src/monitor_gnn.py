...
class MonitorGraphDatasetCSV(CWTGraphDataset):
    def __init__(self, annot_df, crop_dir, true_pred_csv):
        ...
        self._edge_index = torch.tensor([[0,0,1,1,10,10,2,2,2,2,16,16,16,16,16,3,3,3,3,11,11,12,12,12,
                                          4,4,4,4,17,17,17,17,5,5,5,5,13,13,13,14,14,
                                          6,6,6,6,18,18,18,18,18,7,7,7,7,15,15,8,8,9,9],
                                         [2,16,16,3,2,12,0,16,4,10,0,1,3,17,2,1,11,5,16,3,13,10,4,14,
                                          2,17,6,12,16,5,18,4,3,13,7,17,11,5,15,12,6,
                                          4,18,8,14,17,7,9,8,6,5,15,9,18,18,7]])
    # --------------------------------------------------------------
    def get(self, idx):
